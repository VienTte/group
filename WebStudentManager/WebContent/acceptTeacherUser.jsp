...
sqlString="insert into Teacher(Sno,Sname,Ssex,Sage,Sdept,Saddr,Sphone,Spassword) "
		+"values('"+username+"','"+usertruename+"','"+sex+"',"+ageint+",'"+department + "','"+address+"','"+telephone+"','"+password+"')";
%>
<%//执行SQL语句
try{
		Connection con;
...
<form name="form1"  method="POST" action="Tiaozhuan.jsp"   onsubmit="return on_submit1()">
<tr aligin="center">
<td>
用户登录:
</td>
